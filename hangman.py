...
print('1) Самый легкий (2 подсказки, длина слова 3 буквы)')
print('2) Немного посложнее (1 подсказка, длина слова до 4 букв')
print('3) Средний (1 подсказка, длина слова до 5 букв')
print('4) Без ограничений (нет подсказок, длина слова любая')
level = input()
